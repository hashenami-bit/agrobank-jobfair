...
export default function Placeholder() {
  ...
  return (
    <div className="w-full max-w-7xl min-h-[70vh] flex flex-col items-center justify-center px-6 relative z-10">
      <div className="w-24 h-24 mb-8 rounded-full border border-[var(--border)] skeuo-card flex items-center justify-center text-3xl">
        <iconify-icon icon="solar:code-file-linear" class="text-[var(--text-muted)]"></iconify-icon>
      </div>
      <h1 className="text-4xl md:text-5xl font-medium tracking-tight mb-4">{pageName}</h1>
      <p className="text-[var(--text-muted)] text-sm tracking-wide max-w-md text-center">
