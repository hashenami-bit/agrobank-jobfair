  ...
  return (
    <section className="w-full max-w-7xl py-32 px-6 relative">
      <div ref={headerRef} className="flex flex-col md:flex-row justify-between items-start md:items-end mb-16 reveal-up gap-6">
        ...
        <div className="flex items-center space-x-4 text-[var(--text-muted)] border-b border-[var(--border)] pb-2 w-full md:w-1/3 justify-end">
          <iconify-icon icon="solar:user-linear" class="hover:text-[var(--text)] cursor-pointer transition-colors text-lg"></iconify-icon>
          <iconify-icon icon="solar:letter-linear" class="hover:text-[var(--text)] cursor-pointer transition-colors text-lg"></iconify-icon>
          <iconify-icon icon="solar:play-circle-linear" class="hover:text-[var(--text)] cursor-pointer transition-colors text-lg"></iconify-icon>
        </div>
      </div>
      ...
      <div ref={gridRef} className="grid grid-cols-1 md:grid-cols-12 gap-8 reveal-up">
        ...
        <article className="md:col-span-8 group cursor-pointer flex flex-col h-full">
          <div className="w-full aspect-[16/9] overflow-hidden rounded-sm border border-[var(--border)] mb-6 relative">
          ...
          <div>
            <button className="px-6 py-2 border border-[var(--border)] rounded-sm text-[var(--text)] text-[0.65rem] tracking-widest uppercase hover:bg-[var(--brand-green)] hover:text-white transition-all">Read More</button>
          </div>
        </article>
        ...
        <div className="md:col-span-4 flex flex-col gap-8">
          ...
          <article className="group cursor-pointer">
            <div className="w-full aspect-video overflow-hidden rounded-sm border border-[var(--border)] mb-4">
              <img 
            ...
            <div className="text-[0.65rem] text-[var(--text-muted)] tracking-widest uppercase mb-2">Dec 10, 2024</div>
            <h4 className="text-lg text-[var(--text)] font-medium tracking-tight mb-3 group-hover:text-pink-500 transition-colors">Integration with Major Non-Custodial Wallets</h4>
          ...
          <article className="group cursor-pointer">
            <div className="w-full aspect-video overflow-hidden rounded-sm border border-[var(--border)] mb-4 relative flex items-center justify-center">
              <img 
              ...
              />
              <div className="relative z-10 w-12 h-12 bg-black/50 backdrop-blur-sm border border-[var(--border)] flex items-center justify-center rounded-sm group-hover:bg-rose-500/20 group-hover:border-rose-500/50 transition-colors">
                <span className="text-xl font-bold group-hover:text-rose-500 transition-colors">N</span>
              </div>
            </div>
            <div className="text-[0.65rem] text-[var(--text-muted)] tracking-widest uppercase mb-2">Jan 15, 2025</div>
            <h4 className="text-lg text-[var(--text)] font-medium tracking-tight mb-3 group-hover:text-pink-500 transition-colors">NovaChain Tokenomics v2.0 Released</h4>
            <span className="text-[0.65rem] text-pink-500 tracking-widest uppercase font-semibold flex items-center gap-1 group-hover:gap-2 transition-all">
              Read More <iconify-icon icon="solar:arrow-right-linear"></iconify-icon>
            </span>
          </article>
