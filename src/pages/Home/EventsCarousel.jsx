      ...
      >
        ...
        {EVENTS.map((e, i) => (
          ...
          >
            ...
            <span
              className="absolute top-3 left-3 md:top-5 md:left-5 z-10 inline-block text-[0.55rem] md:text-[0.7rem] tracking-widest uppercase px-2 py-0.5 md:px-2.5 md:py-1 rounded-full font-semibold"
              style={{ backgroundColor: accent, color: '#0b0d12' }}
            >
              {L(e.tag)}
            </span>

            {/* Title + description — bottom bar */}
